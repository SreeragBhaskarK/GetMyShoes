...
logInEmailView,changePasswordData,cartCount,updateAddress,addressDelete,about,contact,contactMessage} = require("../controllers/userController")
...
router.post('/contact_message', contactMessage)
